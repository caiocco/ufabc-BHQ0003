...
\noindent
\titlefont Interpretações do\par
\titlefont Brasil\par \null
\subtitlefont Prova 2\par
\epigraph{Sabemos que o capitalismo é uma forma de organização da sociedade intrinsicamente corrupta.}%
{\textit{A construção política do Brasil, p. 360}\\ \textsc{Luiz Carlos Bresser-Pereira}}
\null\vfill
\vspace*{1cm}
\noindent
\hfill
